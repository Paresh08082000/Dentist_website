...
<html lang="en" dir="ltr">
  ...
  ?>
    ...
    <div class="wrapper">
        ...
        <p><center><b>Write correct ID No. of product whose data you want to update</b></center></p>
    ...
    <form class="" action="update_product.php" method="post">
      ...
      <div class="inputfield">
        ...
        <div class="inputfield">
          <input type="submit" value="UPDATE" name="update" class="btn" onclick="alert('product details updated succesfully')">
        </div>
        <div class="inputfield">
